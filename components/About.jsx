      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          ...
          <p className="py-2 text-gray-200">
            ...
            process of creating. I started out my coding journey with the use of
            technologies such as Dreamweaver, Bootstrap, Mobirise and Webflow
            but, as of late, I am using Visual Studio Code, React, Next and
            Tailwind making for more versatile and manageable apps.
          </p>
          <p className="py-2 text-gray-200">
        ...
        <div className="w-full h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center p-4 hover:scale-105 ease-in duration-300">
          <Image className="rounded-xl" src="/assets/about.png" alt="grad" width="500" height="700" />
        </div>
      </div>
    </div>
  );
