...
import dglowImg from "../public/assets/projects/dglow.png";
    ...
    <div className="w-full">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10">
          <h2 className="py-2">Desi Glow</h2>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p>
            This was a recent reboot of an old website I created for a client
            years ago using just Bootstrap! React and Tailwind was the weapon of
            choice for this project!
          </p>
          <a href="https://desiglow.uk" target="_blank" rel="noreferrer">
            <button className="px-8 py-2 mt-4 mr-8 hover:text-[#546E74] hover:font-bold">Demo</button>
          </a>
          <a href="https://github.com/oyousaf/dglow" target="_blank" rel="noreferrer">
